 ...
 */
async function handleDraft(request, stream, token, resources) {
    ...
    stream.markdown('---\n\n');
    const draftResult = await (0, lmAgent_1.sendPromptStreaming)(model, draftPrompt, stream, token);
